            ...
            <div className='flex max-md:flex-col-reverse max-md:items-center w-full md:h-full'>
                ...
                <div className='lg:w-1/2 md:w-[55%] w-full'>
                    <div className='w-full md:h-full h-[300px] overflow-hidden'>
                        <div className=' bg-teal-500 flex justify-center lg:items-end md:items-center items-start rounded-[50%] xl:w-[760px] lg:w-[700px] md:w-[600px] mx-auto sm:w-[500px] overflow-hidden h-[450px] md:h-[700px]'>
                            <img src={img} alt="" className='lg:h-[90%] md:h-[85%] mt-0 md:mt-28 lg:mt-0 xl:mt-0 xl:pr-0 lg:pr-6 md:pr-12 pr-0 h-[350px]' />
                        </div>
                    </div>
                </div>
            </div>
